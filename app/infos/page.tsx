      ...
      <div className="">
        ...
        <div className="flex">
          <div className="max-md:text-xs max-md:mx-1 flex flex-col items-start justify-between my-2">
            <p className="flex items-center bg-background text-foreground dark:border dark:border-slate-700 p-1 px-2 rounded-bl-3xl rounded-tr-3xl">
              <TbCircleNumber1Filled
                size={40}
            ...
            <p className="flex items-center bg-background text-foreground dark:border dark:border-slate-700 p-1 px-2 rounded-bl-3xl rounded-tr-3xl mt-4">
              <TbCircleNumber2Filled
                size={40}
                className="bg-slate-800 text-white rounded-full"
              />
...
const CustomBreadcrumb = ({ name }: { name: string }) => {
  return (
    <Breadcrumb className="p-2 bg-background text-foreground">
      <BreadcrumbList>
        <BreadcrumbItem>
